...
export default function HeroSection({ globeData }: Props) {
  return (
    <div className="relative min-h-[500px] py-6 lg:h-[80vh] lg:py-0">
      <StarField />

      <div className="relative z-10 grid h-full min-h-[inherit] grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-12">
